...
export POSTGRES_INSTANCE_SERVICE_PASSWORD="${POSTGRES_INSTANCE_SERVICE_PASSWORD:-instance_service123}"
export POSTGRES_DATABASE_SERVICE_PASSWORD="${POSTGRES_DATABASE_SERVICE_PASSWORD:-database_service123}"
...
sed -e "s/\${POSTGRES_READONLY_PASSWORD}/$POSTGRES_READONLY_PASSWORD/g" \
    ...
    -e "s/\${POSTGRES_INSTANCE_SERVICE_PASSWORD}/$POSTGRES_INSTANCE_SERVICE_PASSWORD/g" \
    -e "s/\${POSTGRES_DATABASE_SERVICE_PASSWORD}/$POSTGRES_DATABASE_SERVICE_PASSWORD/g" \
